...
|---:|:--- |:--- |:---|:---|
|⭐️`n_neighbors`<br/>*default 15*|This parameter defines what's considered as "close". Th |Focus on the global structure|Focus on local structures||
...
: Table X: HDBSCAN Parameters table {tbl-colwidths="[10, 20, 20, 20, 40]" #tbl-hdbscan-parameters}
