...
The first step is to choose the embedding model as it drastically alters the results of the topic model. 
Then you can focus on the 2 main parameters of the pipeline: `n_neighbors` (UMAP) and `min_cluster_size` (HDBSCAN).
